FROM ubuntu:focal
LABEL author="https://github.com/nicolanore/godot-ci/graphs/contributors"
...
RUN apt-get update && apt-get install -y --no-install-recommends \
    ...
    rsync \
    libxcursor1 libxinerama1 libxrandr2 libxi6 libglu1 \
    && rm -rf /var/lib/apt/lists/*

ENV JAVA_HOME=/usr/lib/jvm/java-11-openjdk-amd64

ARG GODOT_VERSION="4.0"
ARG RELEASE_NAME="beta4"
ARG SUBDIR="/${RELEASE_NAME}"
